...
public class ReconstructionOfTree {
	...
	public static char reconstruct_tree(char[] preorder, char[] inorder)
	{
		...
		int root_left = reconstruct_tree(left_preorder, left_inorder);
		int root_right = reconstruct_tree(right_preorder, right_inorder);
	...
	public static void main(String[] args) {
		...
		System.out.println("Reconstructed Tree is: "+reconstruct_tree(preorder, inorder));
